Ext.define('Admin.view.ctl.sensor.SensorSubAdd', {
	extend: 'Ext.window.Window',
	alias: 'widget.ctl_sensor_SensorSubAdd',
	autoShow: true,//自动打开
    modal: true,//模态窗口
    width: 360,//窗体宽度
//    height: 240,//窗体高度
...
//            		record.set("id", "extModel5-49");
//            		record.set("disp", "23:59");
//            		record.set("date", Ext.Date.parse("2008-01-01 23:59:59", 'Y-m-d H:i:s'));
