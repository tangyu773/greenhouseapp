Ext.define('Admin.view.ctl.liquid.LiquidList', {
	 extend: 'Ext.grid.Panel',
	 alias: 'widget.ctl_liquid_LiquidList',
//	 id: 'ctl_liquid_LiquidList_ID',
	...
	initComponent: function() {
		...
		if(tab.rawParams && tab.rawParams.u == 1){
			...
			this.on('edit', function(editor, e) {
				// 每一行编辑完保存之后，都提交数据
				Ext.Ajax.request({
					url: just.getUrl('/sys/ctl/gh10_ctl_liquid_update_u.action'),
